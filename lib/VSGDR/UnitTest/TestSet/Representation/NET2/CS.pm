package VSGDR::UnitTest::TestSet::Representation::NET2::CS;
...
my $grammar_pass1 = q{
        ...
        testdata: /SqlDatabaseTestActions testActions = this\./ testdata_name[ $arg[0] ] /;/
...
#                testmethod(s)
        ...
        testaction: /Microsoft\.Data\.Tools\.Schema\.Sql\.UnitTesting\.SqlDatabaseTestAction [\w]*;/
        ...
        condition: /Microsoft\.Data\.Tools\.Schema\.Sql\.UnitTesting\.Conditions\./ condition_type condition_name /;/
...
#print Dumper $ast_branch ;
    ...
    foreach my $test ( @tests) {
        ...
        $res .= "${p2}{\n";
        $res .= "${p3}SqlDatabaseTestActions testActions = " . $self->selfKeyWord() . ".".$test->testActionDataName().";\n";
...
#print Dumper ${arg2} ;
    ...
    $res .= "${p3}SqlExecutionResult[] "."${arg3}"." = TestService.Execute(" . $self->selfKeyWord() . ".${arg5}, " . $self->selfKeyWord() . ".PrivilegedContext, testActions.".${arg2}.");\n";
...
{
    [TestClass()]
    public class ${class} : SqlDatabaseTestClass
    {
...
sub Footer {
    ...
    foreach my $test (@tests) {
        $res .= "${p2}private SqlDatabaseTestActions ".$test->testActionDataName().";\n";
    }
...
<ROOT>
    <SECTIONS>
        ...
        {
            SqlDatabaseTestActions testActions = this.<@MethodName@>Data;
